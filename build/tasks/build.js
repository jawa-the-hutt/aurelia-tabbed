...
gulp.task('build-css', function() {
  return gulp.src(paths.css)
    .pipe(gulp.dest(paths.output + 'es2015/assets'))
    .pipe(gulp.dest(paths.output + 'commonjs/assets'))
    .pipe(gulp.dest(paths.output + 'amd/assets'))
    .pipe(gulp.dest(paths.output + 'system/assets'));
});
