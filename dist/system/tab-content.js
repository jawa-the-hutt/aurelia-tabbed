...
System.register(['aurelia-framework'], function (_export, _context) {
    ...
    var inject, bindable, customElement, _dec, _dec2, _class, _desc, _value, _class2, _descriptor, TabContent;
    ...
    return {
        ...
        execute: function () {
            _export('TabContent', TabContent = (_dec = customElement('tab-content'), _dec2 = inject(Element), _dec(_class = _dec2(_class = (_class2 = function () {
